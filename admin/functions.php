...
function obituaries_adminMenu($currentoption = 0, $breadcrumb = '')
{
    ...
    if (file_exists(XOOPS_ROOT_PATH . '/modules/obituaries/language/' . $xoopsConfig['language'] . '/modinfo.php')) {
        require_once XOOPS_ROOT_PATH . '/modules/obituaries/language/' . $xoopsConfig['language'] . '/modinfo.php';
    } else {
        require_once XOOPS_ROOT_PATH . '/modules/obituaries/language/english/modinfo.php';
    }
    global $adminObject;
    ...
    echo "<a href=\"../index.php\">"
         . _AM_OBITUARIES_GO_TO_MODULE
         . "</a> | <a href=\""
         . XOOPS_URL
         . '/modules/system/admin.php?fct=preferences&amp;op=showmod&amp;mod='
         . $xoopsModule->getVar('mid')
         . "\">"
         . _AM_OBITUARIES_PREFERENCES
         . "</a> | <a href='index.php?op=maintain'>"
         . _AM_OBITUARIES_MAINTAIN
         . "</a>\n";
    echo "</td>\n";
