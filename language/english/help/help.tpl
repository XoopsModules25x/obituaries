<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_OBITUARIES_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">With this module you can show Show Obituaries of various people, e.g. your members .</p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/xoopstube-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/xoopstube-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModules25x/xoopstube" target="_blank">GitHub</a><br><br>
