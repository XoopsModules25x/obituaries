...
\define('CO_' . $moduleDirNameUpper . '_TITLE1', 'Short Biography');
\define('CO_' . $moduleDirNameUpper . '_TITLE2', 'Names of Survivors');
\define('CO_' . $moduleDirNameUpper . '_TITLE3', 'Service Announcement');
\define('CO_' . $moduleDirNameUpper . '_TITLE4', 'Memorial Contributions');
//Sample Data
